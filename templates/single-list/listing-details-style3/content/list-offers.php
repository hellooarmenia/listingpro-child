                ...
                <div class="offer-top">
                    ...
                    if( !empty( $discount_data['disExpE'] ) ):
                        ...
                        <div class="offer-expiry">
                            <strong><?php echo esc_html__( 'Validity:', '' ); ?></strong>
                        ...
                        <div class="offer-btn">
                            <div class="lp-dis-code-copy <?php echo 'offer-'.$offer_counter; ?>">
                                <div class="popup-header">
                                    <strong><?php echo esc_html__( 'Coupon Code' ); ?></strong>
                ...
                <div class="dis-code-copy-pop offer-copy-<?php echo $offer_counter; ?>" id="dicount-copy-<?php echo $offer_counter; ?>">
                    ...
                    <div class="dis-code-copy-pop-inner">
                        <div class="dis-code-copy-pop-inner-cell">
                            ...
                            <p class="dis-code-copy-wrap"><input class="code-top-copy-<?php echo $offer_counter; ?>" type="text" value="<?php echo $discount_data['disCod']; ?>"> <a data-target-code="dicount-copy-<?php echo $offer_counter; ?>" href="#" class="copy-now">Copy</a></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
