...
if( !isset($_GET['s'])){
    ...
    if(isset($_GET['lp_s_cat']) && !empty($_GET['lp_s_cat'])){
        ...
        $termName = apply_filters('lp_results_for_label','Results For').' <span class="font-bold term-name">'.$termo->name.'</span>';
        $parent = $termo->parent;
    }
    if(isset($_GET['lp_s_cat']) && empty($_GET['lp_s_cat']) && isset($_GET['lp_s_tag']) && !empty($_GET['lp_s_tag'])){
        ...
        $termName = apply_filters('lp_results_for_label','Results For').' <span class="font-bold">'.$termo->name.'</span>';
    }
